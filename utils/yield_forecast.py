...
def calculate_weather_forecast(field_id, days_ahead=7):
    """Génère des prévisions météo pour un champ"""
    
    # Récupère les 30 derniers jours de données environnementales
    ...
    if not historical_data:
        # Pas de données historiques, utilise des valeurs par défaut
        return {
    ...
    # Extrait les valeurs historiques
